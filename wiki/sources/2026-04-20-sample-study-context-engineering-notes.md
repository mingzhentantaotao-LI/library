...
这份学习笔记把上下文窗口视为有限注意力预算，而不是长期存储空间。它主张把稳定知识外化到可持续的 Markdown 笔记中，并把重复工作流程沉淀为方法页，以减少每次会话的重建成本。

## 关键观点

- 上下文窗口是有限预算，不适合充当长期记忆。
- 稳定知识应外化到可持久保存的 Markdown 页面。
- 笔记应分层为来源事实、可复用概念和当前决策。
- 检索优先返回简洁摘要，并保留回到完整来源的路径。
- 重复工作流应提炼成方法页。
